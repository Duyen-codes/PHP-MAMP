...
class Account {
  ...
  // Deposit method
  function deposite(float $balance):float {
    return $this->balance;
  }
  // Withdraw method
  function withdraw(float $balance):float {
  return $this->balance;
  }

}
$saving_account = new Account(1234, 'Saving', 0.05);
$checking_account = new Account(4567, 'Checking', 0.03);
?>
